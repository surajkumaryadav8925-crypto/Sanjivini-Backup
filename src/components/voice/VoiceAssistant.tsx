...
const HI_COMMANDS: Command[] = [
  { patterns: ["नमस्ते", "नमस्कार", "प्रणाम", "हेलो", "हाय", "namaste", "namaskar", "hello", "hi"], action: "greet" },
  { patterns: ["मदद", "सहायता", "क्या कर सकते हो", "मदद करो", "सहायता चाहिए", "कमांड्स", "help", "madad", "sahayata"], action: "help" },
  { patterns: ["दवाई खोलो", "दवाएं खोलो", "दवा दिखाओ", "दवाई दिखाओ", "दवाइयां", "दवा", "मेडिसिन", "dawai", "medicine", "dawa"], action: "navigate", path: "/patient/medicines" },
  { patterns: ["अस्पताल खोलो", "अस्पताल दिखाओ", "अस्पताल", "हॉस्पिटल खोलो", "नजदीकी अस्पताल", "hospital", "aspatal", "chikitsalaya"], action: "navigate", path: "/patient/hospitals" },
  { patterns: ["जांच खोलो", "टेस्ट दिखाओ", "डायग्नोस्टिक्स खोलो", "लैब टेस्ट", "जांच", "टेस्ट", "diagnostic", "test", "lab"], action: "navigate", path: "/patient/diagnostics" },
  { patterns: ["ओपीडी खोलो", "अपॉइंटमेंट बुक करो", "ओपीडी", "टोकन", "टोकन बुक करो", "opd", "appointment", "token"], action: "navigate", path: "/patient/opd" },
  { patterns: ["आपातकालीन खोलो", "इमरजेंसी", "आपातकालीन सेवा", "एंबुलेंस", "emergency", "ambulance", "aapatkal"], action: "navigate", path: "/patient/emergency" },
  { patterns: ["ब्लड बैंक खोलो", "रक्त उपलब्धता", "ब्लड की उपलब्धता", "खून", "ब्लड बैंक", "रक्त", "blood", "blood bank", "rakt"], action: "navigate", path: "/patient/blood" },
  { patterns: ["बीमा खोलो", "आयुष्मान भारत", "बीमा की जानकारी", "पीएम जय", "PM-JAY", "ayushman", "bima", "insurance"], action: "navigate", path: "/patient/insurance" },
  { patterns: ["स्वास्थ्य रिकॉर्ड खोलो", "मेरे रिकॉर्ड दिखाओ", "पर्चा दिखाओ", "रिकॉर्ड", "ईएचआर", "records", "health records", "parcha"], action: "navigate", path: "/patient/records" },
  { patterns: ["परामर्श खोलो", "वीडियो परामर्श", "डॉक्टर से बात करो", "कंसल्टेशन", "consultation", "doctor"], action: "navigate", path: "/patient/consultation" },
  { patterns: ["परिवार स्वास्थ्य", "परिवार खोलो", "टीकाकरण", "मातृ स्वास्थ्य", "फैमिली", "family", "vaccination", "anc"], action: "navigate", path: "/patient/family" },
  { patterns: ["घर जाओ", "डैशबोर्ड", "होम पेज", "मुख्य पृष्ठ", "डैशबोर्ड खोलो", "home", "dashboard"], action: "navigate", path: "/patient/dashboard" },
];
